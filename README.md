[محک] , [جهان پی] , [کانــال]
***
# <p align="center">ElevenFiftyOne(1151)
####<p align="center">**Telegram GroupManager For Iranian User**
...
## Installation
```bash
# Tested on Ubuntu 15.10, for other OSs check out https://github.com/MojtabaMonfared/ElevenFiftyOne/wiki/Installation
...
|---------|--------|-------| ----- |
| [Bot](https://telegram.me/ElevenFiftyOne) | [Join](https://telegram.me/TG1151Ch) | [Developer](http://telegram.me/PokerFace_Dev) :trollface: | [Email](mailto:mojtabaw442@gmail.com) |
